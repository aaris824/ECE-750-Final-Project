...
int main() {
  ...
  while (wb_robot_step(time_step) != -1) {
    ...
    yawAngle = -yawAngle; // Toggle between left and right
    pitchAngle = -pitchAngle; // Toggle between up and down
    
    passive_wait(2.0); // Ensure passive_wait is properly defined to replicate gesture
  }
