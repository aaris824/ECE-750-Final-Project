...
static void set_natural_arm_position() {
  ...
  // Elbow yaw, slight adjustment if needed
  // wb_motor_set_position(wb_robot_get_device("RElbowYaw"), value);
  // wb_motor_set_position(wb_robot_get_device("LElbowYaw"), value);
}


// main function - some parts like print_help() were from the original nao_demo.c
int main() {
  ...
  // Automatically start walking forward as soon as the simulation starts
  start_motion(forwards);
